...
const Feedback = () => {
  ...
  const sendMail = () => {
    ...
    let body = "Name of the User: <br/>" + usersname + "<br/>" + "Email of the User: <br/>" + usersemail + "<br/><br/>" +
      "What did you like most about 3D Enhancer @aa? <br/>" +
      likes +
      "<br/><br/> Will our 3D and AR features improve your shopping experience if we integrate it on an online e-commerce store ?<br/>" +
      improvement +
      "<br/><br/> What are the other features that excite you to have them on 3D Enhancer @aa ?<br/>" +
      feature +
    ...
    window.Email.send({
      ...
      Subject: "3D Enhancer @aa has got a feedback",
      Body: body,
    }).then((message) => {
        if (message === "OK") {
          window.swal(
  ...
  return (
    <div className="container">
      ...
      <form ref={formRef} onSubmit={(e) => e.preventDefault()}>
        ...
        <label htmlFor="liked">What did you like most about 3D Enhancer @aa?</label>
